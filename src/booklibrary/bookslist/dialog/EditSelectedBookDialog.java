...
public class EditSelectedBookDialog extends Dialog {
	private Text bookTitleText;
	private Text bookAuthorsText;
	private String bookTitle;
	private String bookAuthors;

	public EditSelectedBookDialog(Shell parentShell, BookTo book) {
		super(parentShell);
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText("Book information change");
	};
	...
	protected Control createDialogArea(Composite parent) {
		...
		bookTitleLabel.setText("New title:");
		...
		bookTitleText.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				Text temporaryBookTitle = (Text) e.getSource();
				bookTitle = temporaryBookTitle.getText();
			}
		});
		...
		bookAuthorsLabel.setText("New author:");
	...
	protected void createButtonsForButtonBar(Composite parent) {
		createButton(parent, IDialogConstants.OK_ID, "Save book", true);
